...
//    Set<GraphNode> search(Map<GraphNode,Object> noNeedSearchMap, Integer level, Boolean detail, GraphRelation relation, List<INodeCallBackHandler> callBackHandler, GraphNode... startNodes);
    Set<GraphNode> search(boolean first,Map<GraphNode,Object> noNeedSearchMap, Integer level, Boolean detail, GraphRelation relation, List<INodeCallBackHandler> callBackHandler, GraphNode... startNodes);
}
